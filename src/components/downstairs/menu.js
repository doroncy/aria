const Menu = {
  ...
  main: {
    ...
    items: [
      ...
      {name: "SIRLOIN", description: "250gr Sirloin steak from the Golan Heights, seared in cast-iron skillet, with garden pea cream, porcini mushroom stock, and ratte potato puree. (Full portion / Half portion)", price: "142/84"},
