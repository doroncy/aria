const Menu = {
  entrees: {
    ...
    items: [
      ...
      {name: "LAMB BRIK", description: "Moroccan Filo cigars, filled with lamb and Ras-el-hanout", price: "58"},
      {name: "FISH AND CHIPS", price: "72"},
      {name: "SHRIMP BUN", description: 'Bun filled with chopped shrimp, Japanese lemon cream', price: "58"},
  ...
  deserts: {
    ...
    items: [
      ...
      {name: 'OOPS, I DROPPED THE TART (Tribute to Massimo Bottura)', description: `Passion fruit and meringu tart, poppy seed cake and passion fruit coulis`, price: "52"},
