const Menu = {
  ...
  main: {
    ...
    bg: 'upstairs-main-bg',
    items: [
      {name: "מוסר ים", description: `בחמאת סויה בהירה, עגבניות מנומרות, טימין לימוני ובוקצ'וי (מנה / חצי מנה) `, price: "132/76"},
      ...
      {name: `קפלטי SHORT RIBS`, description: `כיסונים ממולאים בבשר צלעות שבושל במשך 4 שעות עם ירקות שורש ויין אדום לצד פירה קטיפתי (מנה / חצי מנה)`, price: "59/98"},
      {name: `סינטה`, description: `250 גרם של סטייק סינטה מרמת הגולן, צרובה במחבת ברזל, על קרם אפונת גינה, ציר פטריות פורצ׳יני ופירה ראטה (מנה / חצי מנה)`, price: "84/142"},
  ...
  deserts: {
    ...
    items: [
      ...
      {name: "שכבות לוז", description: "קרם אגוזי לוז וטוויל קקאו עם קרמל מלוח וגלידת חמאה חומה", price: "48"},
  ...
  cocktails: {
    ...
    items: [
      ...
      {name: "LADY IN RED", description: `קוקטייל פרחוני ומעודן. ג'ין טנקרי, עם מתיקות של סירופ לבנדר והיבסקוס תוצרת בית, חמיצות של לימון טרי ומעט פרחוניות של ורדים ושושנים. קוקטייל שיגרום לכם ללקק את השפתיים.`, price: "46"},
      ...
      {name: 'ARIA SOUR #4', description: `קוקטייל הבית האהוב והמפורסם שלנו בגרסה חדשה. הנסי v.s , ליקר תפוזים דריי קרסאו, אמרו מונטנגרו, מיץ לימון, סירופ מייפל וחלבון מנוערים היטב. סאוור קלאסי, עוצמתי ומתוחכם כזה שאי אפשר לשכוח.`, price: "49"},
      ...
      {name: 'WHITE NEGRONI', description: `טוויסט מעניין וקליל לקוקטייל הקלאסי והמפורסם. ג'ין, ורמוט צרפתי לבן, אפרול, מרסקינו, ביטר פיישוד ומעט יין לבן יבש, מעורבבים יחדיו ויוצרים קוקטייל עדין ואלכוהולי בעל איזון מושלם בין מרירות, מתיקות וחמיצות הדרים עדינה.`, price: "48"},
  ...
  alcohol: {
    ...
    items: [
      {name: "", description: "ארוחת הטעימות מוגשת בין הימים שבת עד רביעי (כולל) ומחוייבת בהזמנה מראש"},
